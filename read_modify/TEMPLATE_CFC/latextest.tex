...
\usepackage[left=1.3cm,right=4.6cm,top=2.3cm,bottom=4.0cm,marginparwidth=3.4cm]{geometry} % Adjust page margins
...
\put(170, 264){\includegraphics[height=23mm,keepaspectratio]{Images/CFC.jpeg}} % Logo box - maximum height/width: 
}
...
\fancyhead[L]{
    \begin{tabular} % The header
        \large\textbf {CARLOS FERNÁNDEZ CASADO,  S.L} \\ % Company name
        \small\textbf  { \qquad\qquad  OFICINA DE PROYECTOS} \\\\  % subdescription

        \small\textbf  {PROJECT:} \normalsize{CEBU 1234567}  \\ % Pproject's name
        \small\textbf  {DATE:} \normalsize{2023-01-12} % Date create
    \end{tabular}
}
